# Demo App: Persona iOS SDK with Inquiry Template

This repo contains a demo app that generates inquiries from an inquiry template. See the [main README](../README.md) for context.
